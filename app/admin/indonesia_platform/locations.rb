ActiveAdmin.register_page 'Indonesia Platform Locations' do
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX}locations"
    end

    def path
      admin_indonesia_platform_locations_path
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_indonesia_platform_locations_upload_datafile_path,
      download_path: admin_indonesia_platform_locations_download_datafiles_path,
      download_single_data_file_path:
          admin_indonesia_platform_locations_download_datafile_path,
      import_path: admin_indonesia_platform_locations_run_importer_path,
